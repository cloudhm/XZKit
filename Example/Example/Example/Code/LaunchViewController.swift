...
open class LaunchViewController: UIViewController {
    ...
    open override func viewDidAppear(_ animated: Bool) {
        ...
        advertisementView.timerButton.timerView.duration = 10
        advertisementView.timerButton.timerView.isPaused = false
    }
...
extension LaunchViewController {
    ...
    open override func didRecevieRedirection(_ redirection: AppRedirection) -> UIViewController? {
        print(redirection)
        return nil
    }
