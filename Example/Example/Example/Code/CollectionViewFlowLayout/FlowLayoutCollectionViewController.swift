...
class FlowLayoutCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout, CollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView!.register(FlowLayoutCollectionViewCell.self, forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: reuseIdentifier)
        self.collectionView!.register(FlowLayoutCollectionViewCell.self, forSupplementaryViewOfKind: UICollectionElementKindSectionFooter, withReuseIdentifier: reuseIdentifier)
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        switch (collectionViewLayout as! CollectionViewFlowLayout).scrollDirection {
        case .horizontal:
            let item = dataArray[indexPath.section][indexPath.item]
